            ...
            <ul className={styles.experienceList}>
                <li>
                    <Link
                        ...
                        <p className={styles.experienceData}>Nov 2023 - At this moment</p>
                        <div className={styles.experienceWrapper}>
                            ...
                            <p className={styles.experienceText}>Development of a corporate CRM web application for company employees.</p>
                        </div>
                    </Link>
                </li>
                <li>
